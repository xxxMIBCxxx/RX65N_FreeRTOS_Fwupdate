...
void Kernel_Object_init (void)
{
    ...
    ret = xTaskCreate(Task_Led, "Task_Led", 512, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
    ...
    ret = xTaskCreate(Task_Usb, "Task_Usb", 1024, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
    ...
    ret = xTaskCreate(Task_Fwupdate, "Task_Fwupdate", 1024, NULL, 3, NULL);
    if (pdPASS != ret)
    {
        while (1)
        {
